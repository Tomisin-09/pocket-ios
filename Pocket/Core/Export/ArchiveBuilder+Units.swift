...
extension ArchiveBuilder {
    ...
    static func exerciseRecord(_ exercise: Exercise) -> ExerciseRecord {
        ExerciseRecord(
            ...
            includeReach: exercise.includeReach,
            rampWarmupSteps: exercise.rampWarmupSteps,
            rampWarmupHold: exercise.rampWarmupHold,
            rampReachHold: exercise.rampReachHold,
            rampBackoffHold: exercise.rampBackoffHold,
