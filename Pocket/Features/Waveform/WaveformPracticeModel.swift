...
final class WaveformPracticeModel {
    ...
    /// Snags start folded (ADR 0202 D2): the panel is a way to reach and remove marks, not a list
    /// anyone opens the screen to read, and an open one would push Loops and Markers down.
    var snagsExpanded = false
    ...
    @ObservationIgnored var lastNowPlayingPush: Date = .distantPast
