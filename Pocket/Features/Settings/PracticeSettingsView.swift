...
/// row to the hub. Home's **Jump back in** preference (ADR 0193) joins on the same argument, and it
/// is the one row here that describes a screen rather than a run: what Home offers you to resume is
