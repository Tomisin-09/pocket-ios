...
for title/artist/album/**genre**/year/**key** (a closed `MusicalKey` picker — 12 roots ×
major/minor + Unknown — parsed from any legacy free text, ADR 0036)/BPM/**downbeat**, lightweight **collections**,
