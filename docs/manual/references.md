...
So exercises, songs, loops and routines each hold links back to wherever they came from. You paste
an address, name it if you want to, and it sits with the thing it explains until you delete it.
